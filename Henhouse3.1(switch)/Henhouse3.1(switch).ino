    ...
    if(dataa == '0')  //进入蓝牙控制
    {
      ...
      while(1)
      {
         ...
         dataa = Serial.read(); 
          ...
          switch(dataa){
            case '2': dataa = 'a';digitalWrite(13,!digitalRead(13));break;
            case '3': dataa = 'a';digitalWrite(9,!digitalRead(9));break;
            case '4': dataa = 'a';digitalWrite(4,!digitalRead(4));break;
            case '5': dataa = 'a';digitalWrite(A2,!digitalRead(A2));break;
            case '6': dataa = 'a';digitalWrite(10,!digitalRead(10));break;
            }
         if(dataa == '0')  //退出蓝牙控制
         {
            dataa = 'a';
